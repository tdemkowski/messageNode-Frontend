...
const HEROKU_URI = `https://acurac-post-backend.herokuapp.com/`
const OLD_URI = `http://localhost:8080`
  ...
  finishEditHandler = postData => {
    ...
    fetch(HEROKU_URI + "post-image", {
      ...
      .then(fileResData => {
        ...
        return fetch(HEROKU_URI + "graphql", {
          method: "POST",
          body: JSON.stringify(graphqlQuery),
          headers: {
            Authorization: "Bearer " + this.props.token,
